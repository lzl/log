...
i18n.map('en-us', {
  ...
  tips: "Tips",
  tipsText: "\n1. Press `?`: Show/Hide this message. `?` = `Shift` + `/`\n1. Press `n`: Focus the text area.\n1. Press `.`: Refresh this page.\n1. Press `l`: Switch the interface language.\n1. Have issues/feedback? [Send an Email](mailto:lizunlong@gmail.com)."
});
i18n.map('zh-cn', {
  title: "日志",
  ...
  tips: "小技巧",
  tipsText: "\n1. 按`?`键：显示/隐藏小技巧。 `?` = `Shift` + `/`\n1. 按`n`键：聚焦文本框。\n1. 按`.`键：刷新页面。\n1. 按`l`键：切换界面语言。\n1. 使用过程中遇到问题想反馈？[给我发封邮件吧](mailto:lizunlong@gmail.com)。"
});
